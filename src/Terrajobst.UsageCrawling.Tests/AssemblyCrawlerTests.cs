...
public class AssemblyCrawlerTests
{
    ...
    {
        const string Source = @"
            [System.Obsolete(DiagnosticId = ""x"")]
            [System.Runtime.InteropServices.BestFitMappingAttribute(false, ThrowOnUnmappableChar = false)]
            class Test {
            }
        ";
        ...
        var usages = new Dictionary<string, int>
        {
            ...
            { "T:System.Runtime.InteropServices.BestFitMappingAttribute", 1 },
            { "M:System.Runtime.InteropServices.BestFitMappingAttribute.#ctor(System.Boolean)", 1 },
            { "F:System.Runtime.InteropServices.BestFitMappingAttribute.ThrowOnUnmappableChar", 1 }
        };
    ...
    public void Attributes_Event()
    {
        ...
        var usages = new Dictionary<string, int>
        {
            { "T:System.EventHandler", 8 }, // Event + adder + remover + field + generated handlers
            { "T:System.Object", 1 },       // Base
            { "M:System.Object.#ctor", 1 }, // Base call
            ...
            { "T:System.ObsoleteAttribute", 1 },
            { "M:System.ObsoleteAttribute.#ctor", 1 },
            { "M:System.Threading.Interlocked.CompareExchange``1(``0@,``0,``0)", 2 } // Generated handlers 
        };
    ...
    private static void Check(MetadataAssembly assembly, IReadOnlyDictionary<string, int> expectedResultsText)
    {
    ...
    private static MetadataAssembly CompileAssembly(string source)
    {
        var peStream = Compile(source);
        var result = MetadataAssembly.Open(peStream, "dummy");
